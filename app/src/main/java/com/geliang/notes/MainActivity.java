...
import com.geliang.notes.adapter.MainAdapter;
import com.geliang.notes.bean.SQLBean;
import com.geliang.notes.data.CallAlarm;
import com.geliang.notes.db.DatabaseOperation;
import com.geliang.notes.doubledatepicker.DoubleDatePickerDialog;
import com.geliang.notes.view.MyGridView;
...
public class MainActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		try {
			Intent intent = new Intent(MainActivity.this, CallAlarm.class);//onCreate方法中先判断闹钟
				...
				new DoubleDatePickerDialog.OnDateSetListener() {
					...
					public void onDateSet(DatePicker startDatePicker,
						...
						if (startYear < endYear || startYear == endYear
							...
							Intent intent = new Intent(MainActivity.this, DataSearchActivity.class);//跳转到日期搜索
